...
class ElectricParkingBreakAdapter(viewModel: ElectricParkingBreakViewModel, activity: ElectricParkingBreakActivity) : RecyclerView.Adapter<ElectricParkingBreakAdapter.ViewHolder>() {

   private val tag: String = this::class.java.simpleName

    private val contactList: List<Data> = listOf()

    init {
        Log.d(tag, "initialized")
        viewModel.getContacts().observe(activity, Observer {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
     Log.d(tag, "onCreateViewHolder")
        val view = LayoutInflater.from(parent.context).inflate(R.layout.adapter_electricparkingbreak, parent, false)
